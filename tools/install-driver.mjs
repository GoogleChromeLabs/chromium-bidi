...
/**
 * @fileoverview Installs a driver matching browser version defined in
 * `.browser` using `@puppeteer/browsers` to the directory provided as the first
 * argument (default: cwd). The executable path is written to the
 * `executablePath` output param for GitHub actions.
 *
 * Examples:
 *  - `node tools/install-driver.mjs`
 *  - `node tools/install-driver.mjs /tmp/cache`
 */
...
try {
  ...
  setFailed(`Failed to download the browser driver: ${err.message}`);
}
