...
async def test_set_media_features_per_browsing_context(
    ...
    assert await get_media_feature_matches("(prefers-color-scheme: dark)") is True
...
async def test_set_media_features_per_user_context(
    ...
    assert (
        await get_media_feature_matches("(prefers-color-scheme: dark)", context_id)
        is True
    )
...
async def test_set_media_features_globally(
    ...
    assert (
        await get_media_feature_matches("(prefers-color-scheme: dark)", new_context_id)
        is True
    )
