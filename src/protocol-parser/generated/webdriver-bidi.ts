...
/**
 * THIS FILE IS AUTOGENERATED by cddlconv 0.1.8.
...
export const CommandSchema = z.lazy(() => z.object({
"id":JsUintSchema}).and(
CommandDataSchema)
.and(
ExtensibleSchema)
...
export const 
CommandDataSchema = z.lazy(() => z.union([BrowserCommandSchema,BrowsingContextCommandSchema,EmulationCommandSchema,InputCommandSchema,NetworkCommandSchema,ScriptCommandSchema,SessionCommandSchema,StorageCommandSchema,WebExtensionCommandSchema]));
...
export const CommandResponseSchema = z.lazy(() => z.object({
"type":z.literal("success"),"id":JsUintSchema,"result":ResultDataSchema}).and(
ExtensibleSchema)
);
export const ErrorResponseSchema = z.lazy(() => z.object({
"type":z.literal("error"),"id":z.union([JsUintSchema,z.null()]),"error":ErrorCodeSchema,"message":z.string(),"stacktrace":z.string().optional()}).and(
ExtensibleSchema)
);
export const ResultDataSchema = z.lazy(() => z.union([BrowserResultSchema,BrowsingContextResultSchema,EmulationResultSchema,InputResultSchema,NetworkResultSchema,ScriptResultSchema,SessionResultSchema,StorageResultSchema,WebExtensionResultSchema]));
export const EmptyResultSchema = z.lazy(() => ExtensibleSchema);
export const EventSchema = z.lazy(() => z.object({
"type":z.literal("event")}).and(
EventDataSchema)
.and(
ExtensibleSchema)
);
export const 
EventDataSchema = z.lazy(() => z.union([BrowsingContextEventSchema,InputEventSchema,LogEventSchema,NetworkEventSchema,ScriptEventSchema]));
export const 
...
export const SessionResultSchema = z.lazy(() => z.union([Session.EndResultSchema,Session.NewResultSchema,Session.StatusResultSchema,Session.SubscribeResultSchema,Session.UnsubscribeResultSchema]));
export namespace Session {
export const CapabilitiesRequestSchema = z.lazy(() => z.object({
"alwaysMatch":Session.CapabilityRequestSchema.optional(),"firstMatch":z.array(Session.CapabilityRequestSchema).optional()}));
}
export namespace Session {
export const CapabilityRequestSchema = z.lazy(() => z.object({
"acceptInsecureCerts":z.boolean().optional(),"browserName":z.string().optional(),"browserVersion":z.string().optional(),"platformName":z.string().optional(),"proxy":Session.ProxyConfigurationSchema.optional(),"unhandledPromptBehavior":Session.UserPromptHandlerSchema.optional()}).and(
ExtensibleSchema)
);
}
export namespace Session {
export const ProxyConfigurationSchema = z.lazy(() => z.union([Session.AutodetectProxyConfigurationSchema,Session.DirectProxyConfigurationSchema,Session.ManualProxyConfigurationSchema,Session.PacProxyConfigurationSchema,Session.SystemProxyConfigurationSchema]));
}
export namespace Session {
export const 
...
export namespace Session {
export const SubscribeParametersSchema = z.lazy(() => z.object({
...
"method":z.literal("session.subscribe"),"params":Session.SubscribeParametersSchema}));
}
export namespace Session {
...
export const 
BrowserCommandSchema = z.lazy(() => z.union([Browser.CloseSchema,Browser.CreateUserContextSchema,Browser.GetClientWindowsSchema,Browser.GetUserContextsSchema,Browser.RemoveUserContextSchema,Browser.SetClientWindowStateSchema,Browser.SetDownloadBehaviorSchema]));
export const BrowserResultSchema = z.lazy(() => z.union([Browser.CloseResultSchema,Browser.CreateUserContextResultSchema,Browser.GetClientWindowsResultSchema,Browser.GetUserContextsResultSchema,Browser.RemoveUserContextResultSchema,Browser.SetClientWindowStateResultSchema,Browser.SetDownloadBehaviorResultSchema]));
...
export namespace Browser {
export const SetClientWindowStateResultSchema = z.lazy(() => Browser.ClientWindowInfoSchema);
}
export namespace Browser {
export const 
SetDownloadBehaviorSchema = z.lazy(() => z.object({
"method":z.literal("browser.setDownloadBehavior"),"params":Browser.SetDownloadBehaviorParametersSchema}));
}
export namespace Browser {
export const SetDownloadBehaviorParametersSchema = z.lazy(() => z.object({
"downloadBehavior":z.union([Browser.DownloadBehaviorSchema,z.null()]),"userContexts":z.array(Browser.UserContextSchema).min(1).optional()}));
}
export namespace Browser {
export const DownloadBehaviorSchema = z.lazy(() => z.union([Browser.DownloadBehaviorAllowedSchema,Browser.DownloadBehaviorDeniedSchema]));
}
export namespace Browser {
export const 
DownloadBehaviorAllowedSchema = z.lazy(() => z.object({
"type":z.literal("allowed"),"destinationFolder":z.string()}));
}
export namespace Browser {
export const 
DownloadBehaviorDeniedSchema = z.lazy(() => z.object({
"type":z.literal("denied")}));
}
export namespace Browser {
export const SetDownloadBehaviorResultSchema = z.lazy(() => EmptyResultSchema);
}
export const 
...
"context":BrowsingContext.BrowsingContextSchema,"navigation":z.union([BrowsingContext.NavigationSchema,z.null()]),"timestamp":JsUintSchema,"url":z.string(),"userContext":Browser.UserContextSchema.optional()}));
}
export namespace BrowsingContext {
...
export namespace BrowsingContext {
export const 
CaptureScreenshotSchema = z.lazy(() => z.object({
"method":z.literal("browsingContext.captureScreenshot"),"params":BrowsingContext.CaptureScreenshotParametersSchema}));
}
export namespace BrowsingContext {
export const CaptureScreenshotParametersSchema = z.lazy(() => z.object({
"context":BrowsingContext.BrowsingContextSchema,"origin":z.enum(["viewport","document",]).default("viewport").optional(),"format":BrowsingContext.ImageFormatSchema.optional(),"clip":BrowsingContext.ClipRectangleSchema.optional()}));
}
export namespace BrowsingContext {
...
"context":BrowsingContext.BrowsingContextSchema,"userContext":Browser.UserContextSchema.optional()}));
}
export namespace BrowsingContext {
export const 
...
export namespace BrowsingContext {
export const 
LocateNodesSchema = z.lazy(() => z.object({
"method":z.literal("browsingContext.locateNodes"),"params":BrowsingContext.LocateNodesParametersSchema}));
}
export namespace BrowsingContext {
export const LocateNodesParametersSchema = z.lazy(() => z.object({
"context":BrowsingContext.BrowsingContextSchema,"locator":BrowsingContext.LocatorSchema,"maxNodeCount":JsUintSchema.gte(1).optional(),"serializationOptions":Script.SerializationOptionsSchema.optional(),"startNodes":z.array(Script.SharedReferenceSchema).min(1).optional()}));
}
export namespace BrowsingContext {
...
export namespace BrowsingContext {
export const ReloadResultSchema = z.lazy(() => BrowsingContext.NavigateResultSchema);
}
export namespace BrowsingContext {
export const 
...
"context":BrowsingContext.BrowsingContextSchema,"timestamp":JsUintSchema,"url":z.string(),"userContext":Browser.UserContextSchema.optional()}));
}
export namespace BrowsingContext {
export const 
...
"context":BrowsingContext.BrowsingContextSchema,"accepted":z.boolean(),"type":BrowsingContext.UserPromptTypeSchema,"userContext":Browser.UserContextSchema.optional(),"userText":z.string().optional()}));
}
export namespace BrowsingContext {
export const 
...
export namespace Emulation {
export const SetForcedColorsModeThemeOverrideResultSchema = z.lazy(() => EmptyResultSchema);
}
export namespace Emulation {
export const 
...
export namespace Emulation {
export const SetGeolocationOverrideResultSchema = z.lazy(() => EmptyResultSchema);
}
export namespace Emulation {
export const 
...
export namespace Emulation {
export const 
SetNetworkConditionsSchema = z.lazy(() => z.object({
"method":z.literal("emulation.setNetworkConditions"),"params":Emulation.SetNetworkConditionsParametersSchema}));
}
export namespace Emulation {
export const SetNetworkConditionsParametersSchema = z.lazy(() => z.object({
"networkConditions":z.union([Emulation.NetworkConditionsSchema,z.null()]),"contexts":z.array(BrowsingContext.BrowsingContextSchema).min(1).optional(),"userContexts":z.array(Browser.UserContextSchema).min(1).optional()}));
}
export namespace Emulation {
export const NetworkConditionsSchema = z.lazy(() => Emulation.NetworkConditionsOfflineSchema);
}
export namespace Emulation {
export const NetworkConditionsOfflineSchema = z.lazy(() => z.object({
"type":z.literal("offline")}));
}
export namespace Emulation {
export const SetNetworkConditionsResultSchema = z.lazy(() => EmptyResultSchema);
}
export namespace Emulation {
export const 
SetScreenSettingsOverrideSchema = z.lazy(() => z.object({
"method":z.literal("emulation.setScreenSettingsOverride"),"params":Emulation.SetScreenSettingsOverrideParametersSchema}));
}
export namespace Emulation {
export const ScreenAreaSchema = z.lazy(() => z.object({
"width":JsUintSchema,"height":JsUintSchema}));
}
export namespace Emulation {
export const SetScreenSettingsOverrideParametersSchema = z.lazy(() => z.object({
"screenArea":z.union([Emulation.ScreenAreaSchema,z.null()]),"contexts":z.array(BrowsingContext.BrowsingContextSchema).min(1).optional(),"userContexts":z.array(Browser.UserContextSchema).min(1).optional()}));
}
export namespace Emulation {
export const SetScreenSettingsOverrideResultSchema = z.lazy(() => EmptyResultSchema);
}
export namespace Emulation {
export const 
...
export namespace Emulation {
export const SetScreenOrientationOverrideResultSchema = z.lazy(() => EmptyResultSchema);
}
export namespace Emulation {
export const 
SetUserAgentOverrideSchema = z.lazy(() => z.object({
"method":z.literal("emulation.setUserAgentOverride"),"params":Emulation.SetUserAgentOverrideParametersSchema}));
}
export namespace Emulation {
export const SetUserAgentOverrideParametersSchema = z.lazy(() => z.object({
"userAgent":z.union([z.string(),z.null()]),"contexts":z.array(BrowsingContext.BrowsingContextSchema).min(1).optional(),"userContexts":z.array(Browser.UserContextSchema).min(1).optional()}));
}
export namespace Emulation {
export const SetUserAgentOverrideResultSchema = z.lazy(() => EmptyResultSchema);
}
export namespace Emulation {
export const 
...
export namespace Emulation {
export const SetScriptingEnabledResultSchema = z.lazy(() => EmptyResultSchema);
}
export namespace Emulation {
export const 
SetScrollbarTypeOverrideSchema = z.lazy(() => z.object({
"method":z.literal("emulation.setScrollbarTypeOverride"),"params":Emulation.SetScrollbarTypeOverrideParametersSchema}));
}
export namespace Emulation {
export const SetScrollbarTypeOverrideParametersSchema = z.lazy(() => z.object({
"scrollbarType":z.union([z.literal("classic"),z.literal("overlay"),z.null()]),"contexts":z.array(BrowsingContext.BrowsingContextSchema).min(1).optional(),"userContexts":z.array(Browser.UserContextSchema).min(1).optional()}));
}
export namespace Emulation {
export const SetScrollbarTypeOverrideResultSchema = z.lazy(() => EmptyResultSchema);
}
export namespace Emulation {
export const 
...
export namespace Emulation {
export const SetTimezoneOverrideResultSchema = z.lazy(() => EmptyResultSchema);
}
export namespace Emulation {
export const 
SetTouchOverrideSchema = z.lazy(() => z.object({
"method":z.literal("emulation.setTouchOverride"),"params":Emulation.SetTouchOverrideParametersSchema}));
}
export namespace Emulation {
export const SetTouchOverrideParametersSchema = z.lazy(() => z.object({
"maxTouchPoints":z.union([JsUintSchema.gte(1),z.null()]),"contexts":z.array(BrowsingContext.BrowsingContextSchema).min(1).optional(),"userContexts":z.array(Browser.UserContextSchema).min(1).optional()}));
}
export namespace Emulation {
export const SetTouchOverrideResultSchema = z.lazy(() => EmptyResultSchema);
}
export const 
NetworkCommandSchema = z.lazy(() => z.union([Network.AddDataCollectorSchema,Network.AddInterceptSchema,Network.ContinueRequestSchema,Network.ContinueResponseSchema,Network.ContinueWithAuthSchema,Network.DisownDataSchema,Network.FailRequestSchema,Network.GetDataSchema,Network.ProvideResponseSchema,Network.RemoveDataCollectorSchema,Network.RemoveInterceptSchema,Network.SetCacheBehaviorSchema,Network.SetExtraHeadersSchema]));
export const NetworkResultSchema = z.lazy(() => z.union([Network.AddDataCollectorResultSchema,Network.AddInterceptResultSchema,Network.ContinueRequestResultSchema,Network.ContinueResponseResultSchema,Network.ContinueWithAuthResultSchema,Network.DisownDataResultSchema,Network.FailRequestResultSchema,Network.GetDataResultSchema,Network.ProvideResponseResultSchema,Network.RemoveDataCollectorResultSchema,Network.RemoveInterceptResultSchema,Network.SetCacheBehaviorResultSchema,Network.SetExtraHeadersResultSchema]));
export const 
NetworkEventSchema = z.lazy(() => z.union([Network.AuthRequiredSchema,Network.BeforeRequestSentSchema,Network.FetchErrorSchema,Network.ResponseCompletedSchema,Network.ResponseStartedSchema]));
...
export namespace Network {
export const 
AddInterceptSchema = z.lazy(() => z.object({
"method":z.literal("network.addIntercept"),"params":Network.AddInterceptParametersSchema}));
}
export namespace Network {
export const AddInterceptParametersSchema = z.lazy(() => z.object({
"phases":z.array(Network.InterceptPhaseSchema).min(1),"contexts":z.array(BrowsingContext.BrowsingContextSchema).min(1).optional(),"urlPatterns":z.array(Network.UrlPatternSchema).optional()}));
}
export namespace Network {
...
export namespace Network {
export const RemoveDataCollectorResultSchema = z.lazy(() => EmptyResultSchema);
}
export namespace Network {
export const 
...
export namespace Network {
export const 
SetCacheBehaviorSchema = z.lazy(() => z.object({
"method":z.literal("network.setCacheBehavior"),"params":Network.SetCacheBehaviorParametersSchema}));
}
export namespace Network {
export const SetCacheBehaviorParametersSchema = z.lazy(() => z.object({
"cacheBehavior":z.enum(["default","bypass",]),"contexts":z.array(BrowsingContext.BrowsingContextSchema).min(1).optional()}));
}
export namespace Network {
...
export namespace Network {
export const 
SetExtraHeadersSchema = z.lazy(() => z.object({
"method":z.literal("network.setExtraHeaders"),"params":Network.SetExtraHeadersParametersSchema}));
}
export namespace Network {
export const SetExtraHeadersParametersSchema = z.lazy(() => z.object({
"headers":z.array(Network.HeaderSchema),"contexts":z.array(BrowsingContext.BrowsingContextSchema).min(1).optional(),"userContexts":z.array(Browser.UserContextSchema).min(1).optional()}));
}
export namespace Network {
...
export namespace Network {
export const 
AuthRequiredSchema = z.lazy(() => z.object({
"method":z.literal("network.authRequired"),"params":Network.AuthRequiredParametersSchema}));
}
export namespace Network {
export const AuthRequiredParametersSchema = z.lazy(() => Network.BaseParametersSchema.and(
z.object({
...
export namespace Network {
export const 
BeforeRequestSentSchema = z.lazy(() => z.object({
"method":z.literal("network.beforeRequestSent"),"params":Network.BeforeRequestSentParametersSchema}));
}
export namespace Network {
export const BeforeRequestSentParametersSchema = z.lazy(() => Network.BaseParametersSchema.and(
z.object({
...
export namespace Network {
export const 
FetchErrorSchema = z.lazy(() => z.object({
"method":z.literal("network.fetchError"),"params":Network.FetchErrorParametersSchema}));
}
export namespace Network {
export const FetchErrorParametersSchema = z.lazy(() => Network.BaseParametersSchema.and(
z.object({
"errorText":z.string()}))
);
}
export namespace Network {
export const 
ResponseCompletedSchema = z.lazy(() => z.object({
"method":z.literal("network.responseCompleted"),"params":Network.ResponseCompletedParametersSchema}));
}
export namespace Network {
export const ResponseCompletedParametersSchema = z.lazy(() => Network.BaseParametersSchema.and(
z.object({
"response":Network.ResponseDataSchema}))
);
}
export namespace Network {
export const 
ResponseStartedSchema = z.lazy(() => z.object({
"method":z.literal("network.responseStarted"),"params":Network.ResponseStartedParametersSchema}));
}
export namespace Network {
...
export const 
ScriptCommandSchema = z.lazy(() => z.union([Script.AddPreloadScriptSchema,Script.CallFunctionSchema,Script.DisownSchema,Script.EvaluateSchema,Script.GetRealmsSchema,Script.RemovePreloadScriptSchema]));
export const ScriptResultSchema = z.lazy(() => z.union([Script.AddPreloadScriptResultSchema,Script.CallFunctionResultSchema,Script.DisownResultSchema,Script.EvaluateResultSchema,Script.GetRealmsResultSchema,Script.RemovePreloadScriptResultSchema]));
export const 
ScriptEventSchema = z.lazy(() => z.union([Script.MessageSchema,Script.RealmCreatedSchema,Script.RealmDestroyedSchema]));
...
export namespace Script {
export const ChannelPropertiesSchema = z.lazy(() => z.object({
"channel":Script.ChannelSchema,"serializationOptions":Script.SerializationOptionsSchema.optional(),"ownership":Script.ResultOwnershipSchema.optional()}));
}
export namespace Script {
export const EvaluateResultSchema = z.lazy(() => z.union([Script.EvaluateResultSuccessSchema,Script.EvaluateResultExceptionSchema]));
}
export namespace Script {
export const EvaluateResultSuccessSchema = z.lazy(() => z.object({
"type":z.literal("success"),"result":Script.RemoteValueSchema,"realm":Script.RealmSchema}));
}
export namespace Script {
export const EvaluateResultExceptionSchema = z.lazy(() => z.object({
"type":z.literal("exception"),"exceptionDetails":Script.ExceptionDetailsSchema,"realm":Script.RealmSchema}));
}
export namespace Script {
export const ExceptionDetailsSchema = z.lazy(() => z.object({
"columnNumber":JsUintSchema,"exception":Script.RemoteValueSchema,"lineNumber":JsUintSchema,"stackTrace":Script.StackTraceSchema,"text":z.string()}));
}
export namespace Script {
...
export namespace Script {
export const ArrayLocalValueSchema = z.lazy(() => z.object({
"type":z.literal("array"),"value":Script.ListLocalValueSchema}));
}
export namespace Script {
export const 
DateLocalValueSchema = z.lazy(() => z.object({
...
"type":z.literal("map"),"value":Script.MappingLocalValueSchema}));
}
export namespace Script {
export const ObjectLocalValueSchema = z.lazy(() => z.object({
"type":z.literal("object"),"value":Script.MappingLocalValueSchema}));
}
export namespace Script {
export const RegExpValueSchema = z.lazy(() => z.object({
"pattern":z.string(),"flags":z.string().optional()}));
}
export namespace Script {
export const 
RegExpLocalValueSchema = z.lazy(() => z.object({
"type":z.literal("regexp"),"value":Script.RegExpValueSchema}));
}
export namespace Script {
export const SetLocalValueSchema = z.lazy(() => z.object({
"type":z.literal("set"),"value":Script.ListLocalValueSchema}));
}
export namespace Script {
...
z.object({
"type":z.literal("window"),"context":BrowsingContext.BrowsingContextSchema,"userContext":Browser.UserContextSchema.optional(),"sandbox":z.string().optional()}))
);
}
export namespace Script {
...
export namespace Script {
export const SharedReferenceSchema = z.lazy(() => z.object({
"sharedId":Script.SharedIdSchema,"handle":Script.HandleSchema.optional()}).and(
ExtensibleSchema)
);
}
export namespace Script {
export const RemoteObjectReferenceSchema = z.lazy(() => z.object({
"handle":Script.HandleSchema,"sharedId":Script.SharedIdSchema.optional()}).and(
ExtensibleSchema)
);
}
export namespace Script {
...
"realm":Script.RealmSchema,"context":BrowsingContext.BrowsingContextSchema.optional(),"userContext":Browser.UserContextSchema.optional()}));
}
export namespace Script {
...
export namespace Script {
export const 
CallFunctionSchema = z.lazy(() => z.object({
"method":z.literal("script.callFunction"),"params":Script.CallFunctionParametersSchema}));
}
export namespace Script {
export const CallFunctionParametersSchema = z.lazy(() => z.object({
"functionDeclaration":z.string(),"awaitPromise":z.boolean(),"target":Script.TargetSchema,"arguments":z.array(Script.LocalValueSchema).optional(),"resultOwnership":Script.ResultOwnershipSchema.optional(),"serializationOptions":Script.SerializationOptionsSchema.optional(),"this":Script.LocalValueSchema.optional(),"userActivation":z.boolean().default(false).optional()}));
}
export namespace Script {
export const CallFunctionResultSchema = z.lazy(() => Script.EvaluateResultSchema);
}
export namespace Script {
export const 
...
export namespace Script {
export const RemovePreloadScriptResultSchema = z.lazy(() => EmptyResultSchema);
}
export namespace Script {
export const 
MessageSchema = z.lazy(() => z.object({
"method":z.literal("script.message"),"params":Script.MessageParametersSchema}));
}
export namespace Script {
export const MessageParametersSchema = z.lazy(() => z.object({
"channel":Script.ChannelSchema,"data":Script.RemoteValueSchema,"source":Script.SourceSchema}));
}
export namespace Script {
export const 
RealmCreatedSchema = z.lazy(() => z.object({
"method":z.literal("script.realmCreated"),"params":Script.RealmInfoSchema}));
}
export namespace Script {
export const 
...
export namespace Log {
export const 
EntryAddedSchema = z.lazy(() => z.object({
"method":z.literal("log.entryAdded"),"params":Log.EntrySchema}));
}
export const 
InputCommandSchema = z.lazy(() => z.union([Input.PerformActionsSchema,Input.ReleaseActionsSchema,Input.SetFilesSchema]));
export const InputResultSchema = z.lazy(() => z.union([Input.PerformActionsResultSchema,Input.ReleaseActionsResultSchema,Input.SetFilesResultSchema]));
export const 
InputEventSchema = z.lazy(() => Input.FileDialogOpenedSchema);
export namespace Input {
export const ElementOriginSchema = z.lazy(() => z.object({
"type":z.literal("element"),"element":Script.SharedReferenceSchema}));
}
export namespace Input {
export const 
PerformActionsSchema = z.lazy(() => z.object({
"method":z.literal("input.performActions"),"params":Input.PerformActionsParametersSchema}));
}
export namespace Input {
export const PerformActionsParametersSchema = z.lazy(() => z.object({
"context":BrowsingContext.BrowsingContextSchema,"actions":z.array(Input.SourceActionsSchema)}));
}
export namespace Input {
export const SourceActionsSchema = z.lazy(() => z.union([Input.NoneSourceActionsSchema,Input.KeySourceActionsSchema,Input.PointerSourceActionsSchema,Input.WheelSourceActionsSchema]));
}
export namespace Input {
export const NoneSourceActionsSchema = z.lazy(() => z.object({
"type":z.literal("none"),"id":z.string(),"actions":z.array(Input.NoneSourceActionSchema)}));
}
export namespace Input {
export const NoneSourceActionSchema = z.lazy(() => Input.PauseActionSchema);
}
export namespace Input {
export const KeySourceActionsSchema = z.lazy(() => z.object({
"type":z.literal("key"),"id":z.string(),"actions":z.array(Input.KeySourceActionSchema)}));
}
export namespace Input {
export const KeySourceActionSchema = z.lazy(() => z.union([Input.PauseActionSchema,Input.KeyDownActionSchema,Input.KeyUpActionSchema]));
}
export namespace Input {
...
export namespace Input {
export const PointerParametersSchema = z.lazy(() => z.object({
"pointerType":Input.PointerTypeSchema.default("mouse").optional()}));
}
export namespace Input {
export const PointerSourceActionSchema = z.lazy(() => z.union([Input.PauseActionSchema,Input.PointerDownActionSchema,Input.PointerUpActionSchema,Input.PointerMoveActionSchema]));
}
export namespace Input {
export const WheelSourceActionsSchema = z.lazy(() => z.object({
"type":z.literal("wheel"),"id":z.string(),"actions":z.array(Input.WheelSourceActionSchema)}));
}
export namespace Input {
export const WheelSourceActionSchema = z.lazy(() => z.union([Input.PauseActionSchema,Input.WheelScrollActionSchema]));
}
export namespace Input {
export const PauseActionSchema = z.lazy(() => z.object({
"type":z.literal("pause"),"duration":JsUintSchema.optional()}));
}
export namespace Input {
export const KeyDownActionSchema = z.lazy(() => z.object({
"type":z.literal("keyDown"),"value":z.string()}));
}
export namespace Input {
export const KeyUpActionSchema = z.lazy(() => z.object({
"type":z.literal("keyUp"),"value":z.string()}));
}
export namespace Input {
export const PointerUpActionSchema = z.lazy(() => z.object({
"type":z.literal("pointerUp"),"button":JsUintSchema}));
}
export namespace Input {
export const PointerDownActionSchema = z.lazy(() => z.object({
"type":z.literal("pointerDown"),"button":JsUintSchema}).and(
Input.PointerCommonPropertiesSchema)
);
}
export namespace Input {
export const PointerMoveActionSchema = z.lazy(() => z.object({
"type":z.literal("pointerMove"),"x":z.number(),"y":z.number(),"duration":JsUintSchema.optional(),"origin":Input.OriginSchema.optional()}).and(
Input.PointerCommonPropertiesSchema)
);
}
export namespace Input {
export const WheelScrollActionSchema = z.lazy(() => z.object({
"type":z.literal("scroll"),"x":JsIntSchema,"y":JsIntSchema,"deltaX":JsIntSchema,"deltaY":JsIntSchema,"duration":JsUintSchema.optional(),"origin":Input.OriginSchema.default("viewport").optional()}));
}
export namespace Input {
export const 
PointerCommonPropertiesSchema = z.lazy(() => z.object({
"width":JsUintSchema.default(1).optional(),"height":JsUintSchema.default(1).optional(),"pressure":z.number().default(0).optional(),"tangentialPressure":z.number().default(0).optional(),"twist":z.number().int().nonnegative().gte(0).lte(359).default(0).optional(),"altitudeAngle":z.number().gte(0).lte(1.5707963267948966).default(0).optional(),"azimuthAngle":z.number().gte(0).lte(6.283185307179586).default(0).optional()}));
}
export namespace Input {
export const OriginSchema = z.lazy(() => z.union([z.literal("viewport"),z.literal("pointer"),Input.ElementOriginSchema]));
}
export namespace Input {
...
export namespace Input {
export const 
ReleaseActionsSchema = z.lazy(() => z.object({
"method":z.literal("input.releaseActions"),"params":Input.ReleaseActionsParametersSchema}));
}
export namespace Input {
export const ReleaseActionsParametersSchema = z.lazy(() => z.object({
"context":BrowsingContext.BrowsingContextSchema}));
}
export namespace Input {
...
export namespace Input {
export const 
SetFilesSchema = z.lazy(() => z.object({
"method":z.literal("input.setFiles"),"params":Input.SetFilesParametersSchema}));
}
export namespace Input {
export const SetFilesParametersSchema = z.lazy(() => z.object({
...
"context":BrowsingContext.BrowsingContextSchema,"userContext":Browser.UserContextSchema.optional(),"element":Script.SharedReferenceSchema.optional(),"multiple":z.boolean()}));
}
export const 
WebExtensionCommandSchema = z.lazy(() => z.union([WebExtension.InstallSchema,WebExtension.UninstallSchema]));
export const WebExtensionResultSchema = z.lazy(() => z.union([WebExtension.InstallResultSchema,WebExtension.UninstallResultSchema]));
export namespace WebExtension {
export const ExtensionSchema = z.lazy(() => z.string());
}
export namespace WebExtension {
export const 
InstallSchema = z.lazy(() => z.object({
"method":z.literal("webExtension.install"),"params":WebExtension.InstallParametersSchema}));
}
export namespace WebExtension {
export const InstallParametersSchema = z.lazy(() => z.object({
