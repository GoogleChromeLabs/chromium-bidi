...
export const 
CommandDataSchema = z.lazy(() => z.union([BrowserCommandSchema,BrowsingContextCommandSchema,InputCommandSchema,NetworkCommandSchema,ScriptCommandSchema,SessionCommandSchema,StorageCommandSchema,WebExtensionCommandSchema,AutofillCommandSchema]));
export const ResultDataSchema = z.lazy(() => z.union([BrowsingContextResultSchema,EmptyResultSchema,NetworkResultSchema,ScriptResultSchema,SessionResultSchema,StorageResultSchema,WebExtensionResultSchema]));
...
export const SessionResultSchema = z.lazy(() => z.union([Session.NewResultSchema,Session.StatusResultSchema,Session.SubscribeResultSchema]));
export namespace Session {
...
"proxyType":z.literal("manual"),"ftpProxy":z.string().optional(),"httpProxy":z.string().optional(),"sslProxy":z.string().optional()}).and(
...
"method":z.literal("browser.createUserContext"),"params":EmptyParamsSchema}));
}
export namespace Browser {
...
export namespace BrowsingContext {
export const NavigationInfoSchema = z.lazy(() => z.object({
...
"context":BrowsingContext.BrowsingContextSchema,"url":z.string()}));
}
export namespace BrowsingContext {
export const 
...
"method":z.literal("browsingContext.downloadWillBegin"),"params":BrowsingContext.NavigationInfoSchema}));
}
export namespace BrowsingContext {
export const 
...
export const 
NetworkCommandSchema = z.lazy(() => z.union([Network.AddInterceptSchema,Network.ContinueRequestSchema,Network.ContinueResponseSchema,Network.ContinueWithAuthSchema,Network.FailRequestSchema,Network.ProvideResponseSchema,Network.RemoveInterceptSchema,Network.SetCacheBehaviorSchema]));
export const 
...
export const ScriptResultSchema = z.lazy(() => z.union([Script.AddPreloadScriptResultSchema,Script.EvaluateResultSchema,Script.GetRealmsResultSchema]));
export namespace Network {
export const 
...
export namespace Script {
export const DateLocalValueSchema = z.lazy(() => z.object({
...
export namespace Script {
export const RegExpLocalValueSchema = z.lazy(() => z.object({
...
export namespace Script {
export const RegExpRemoteValueSchema = z.lazy(() => z.object({
"handle":Script.HandleSchema.optional(),"internalId":Script.InternalIdSchema.optional()}).and(Script.RegExpLocalValueSchema));
}
export namespace Script {
export const DateRemoteValueSchema = z.lazy(() => z.object({
"handle":Script.HandleSchema.optional(),"internalId":Script.InternalIdSchema.optional()}).and(Script.DateLocalValueSchema));
}
export namespace Script {
...
"method":z.literal("autofill.trigger"),"params":Autofill.TriggerParametersSchema}));
}
export namespace Autofill {
export const TriggerParametersSchema = z.lazy(() => z.object({
"context":BrowsingContext.BrowsingContextSchema,"element":Script.SharedReferenceSchema,"field":Autofill.FieldSchema}));
}
export namespace Autofill {
