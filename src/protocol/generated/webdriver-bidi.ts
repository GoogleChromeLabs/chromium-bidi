...
"method":("session.subscribe"),"params":(Session.SubscribeParameters)});
}
export namespace Session {
...
"method":("browser.setDownloadBehavior"),"params":(Browser.SetDownloadBehaviorParameters)});
}
export namespace Browser {
export type SetDownloadBehaviorParameters = (({
"downloadBehavior":(Browser.DownloadBehavior| null),"userContexts"?:([
(Browser.UserContext),...(Browser.UserContext)[]])}));
}
export namespace Browser {
...
"context":(BrowsingContext.BrowsingContext),"navigation":(BrowsingContext.Navigation| null),"timestamp":(JsUint),"url":(string),"userContext"?:(Browser.UserContext)});
}
export namespace BrowsingContext {
...
"context":(BrowsingContext.BrowsingContext),"userContext"?:(Browser.UserContext)}));
}
export namespace BrowsingContext {
export type GetTree = ({
...
"context":(BrowsingContext.BrowsingContext),"timestamp":(JsUint),"url":(string),"userContext"?:(Browser.UserContext)}));
}
export namespace BrowsingContext {
...
"context":(BrowsingContext.BrowsingContext),"accepted":(boolean),"type":(BrowsingContext.UserPromptType),"userContext"?:(Browser.UserContext),"userText"?:(string)}));
}
export namespace BrowsingContext {
...
"context":(BrowsingContext.BrowsingContext),"handler":(Session.UserPromptHandlerType),"message":(string),"type":(BrowsingContext.UserPromptType),"userContext"?:(Browser.UserContext),"defaultValue"?:(string)}));
}
...
"method":("emulation.setNetworkConditions"),"params":(Emulation.SetNetworkConditionsParameters)});
}
export namespace Emulation {
export type SetNetworkConditionsParameters = (({
"networkConditions":(Emulation.NetworkConditions| null),"contexts"?:([
(BrowsingContext.BrowsingContext),...(BrowsingContext.BrowsingContext)[]]),"userContexts"?:([
(Browser.UserContext),...(Browser.UserContext)[]])}));
}
export namespace Emulation {
...
"method":("emulation.setScreenSettingsOverride"),"params":(Emulation.SetScreenSettingsOverrideParameters)});
}
export namespace Emulation {
...
"screenArea":(Emulation.ScreenArea| null),"contexts"?:([
(BrowsingContext.BrowsingContext),...(BrowsingContext.BrowsingContext)[]]),"userContexts"?:([
(Browser.UserContext),...(Browser.UserContext)[]])}));
}
export namespace Emulation {
...
"method":("emulation.setScrollbarTypeOverride"),"params":(Emulation.SetScrollbarTypeOverrideParameters)});
}
export namespace Emulation {
export type SetScrollbarTypeOverrideParameters = (({
"scrollbarType":("classic"| "overlay"| null),"contexts"?:([
(BrowsingContext.BrowsingContext),...(BrowsingContext.BrowsingContext)[]]),"userContexts"?:([
(Browser.UserContext),...(Browser.UserContext)[]])}));
}
export namespace Emulation {
...
"method":("emulation.setTouchOverride"),"params":(Emulation.SetTouchOverrideParameters)});
}
export namespace Emulation {
 ...
 * Must be greater than or equal to `1`.
 */
"maxTouchPoints":((JsUint)| null),"contexts"?:([
(BrowsingContext.BrowsingContext),...(BrowsingContext.BrowsingContext)[]]),"userContexts"?:([
(Browser.UserContext),...(Browser.UserContext)[]])}));
}
export namespace Emulation {
...
"context":(BrowsingContext.BrowsingContext| null),"isBlocked":(boolean),"navigation":(BrowsingContext.Navigation| null),"redirectCount":(JsUint),"request":(Network.RequestData),"timestamp":(JsUint),"userContext"?:(Browser.UserContext| null),"intercepts"?:([
...
export namespace Network {
export const enum DataType {Request = "request",
Response = "response",
}
}
export namespace Network {
...
"type":("window"),"context":(BrowsingContext.BrowsingContext),"userContext"?:(Browser.UserContext),"sandbox"?:(string)}));
}
export namespace Script {
...
export namespace Script {
export type Source = (({
"realm":(Script.Realm),"context"?:(BrowsingContext.BrowsingContext),"userContext"?:(Browser.UserContext)}));
}
export namespace Script {
...
"context":(BrowsingContext.BrowsingContext),"userContext"?:(Browser.UserContext),"element"?:(Script.SharedReference),"multiple":(boolean)}));
}
