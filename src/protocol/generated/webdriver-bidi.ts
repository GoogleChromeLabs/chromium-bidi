...
export type CommandData = (BrowserCommand| BrowsingContextCommand| InputCommand| NetworkCommand| ScriptCommand| SessionCommand| StorageCommand| WebExtensionCommand| AutofillCommand);
...
"proxyType":("manual"),"ftpProxy"?:(string),"httpProxy"?:(string),"sslProxy"?:(string)}&({} |Session.SocksProxyConfiguration)&{
"noProxy"?:([
...((string)[])])}&Extensible);
}
export namespace Session {
...
"method":("browser.createUserContext"),"params":(EmptyParams)});
}
export namespace Browser {
...
"context":(BrowsingContext.BrowsingContext),"url":(string)}));
}
export namespace BrowsingContext {
...
"method":("browsingContext.downloadWillBegin"),"params":(BrowsingContext.NavigationInfo)});
}
export namespace BrowsingContext {
...
"context":(BrowsingContext.BrowsingContext),"element":(Script.SharedReference),"field":(Autofill.Field)}));
}
export namespace Autofill {
export type Field = (({
