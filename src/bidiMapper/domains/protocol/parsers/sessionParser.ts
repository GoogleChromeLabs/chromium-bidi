import { Session } from '../bidiProtocolTypes';
...
export class SubscribeParamsParser {
  static parse(params: any): Session.SubscribeParameters {
    return {
      contexts: BrowsingContextParser.parseOptionalList(params.contexts),
